...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'ssh_command_sudo' => 'Sudo Pfad',
        'ssh_command_postqueue' => 'Postqueue Pfad',
        'ssh_command_postsuper' => 'Postsuper Pfad',
        'hostname' => 'Hostname',
        'client_type' => 'Client Typ',
        'client_payload' => 'Client',
        'sender_type' => 'Absender Typ',
        'sender_payload' => 'Absender',
        'action' => 'Aktion',
        'message' => 'Nachricht',
        ...
        'use_ssl' => 'SSL benutzen',
        'use_tls' => 'TLS benutzen',
        'ignored_domains' => 'Ignorierte Domänen (Empfänger Abfrage)',
        'group_dn' => 'Gruppe (DN)',
        'account_prefix' => 'Account Prefix',
        'account_suffix' => 'Account Suffix',
        'discover_attr' => 'Discover Attribut',
        'authenticate_attr' => 'Authentifizierungs Attribut',
        'sso_auth_attr' => 'Single Sign On Attribut',
        'password_sync' => 'Passwort Sync',
        'domain' => 'Domäne',
        'payload' => 'Eintrag',
        'transport' => 'Transport',
        'nexthop_type' => 'Nexthop Typ',
        'nexthop' => 'Nexthop',
