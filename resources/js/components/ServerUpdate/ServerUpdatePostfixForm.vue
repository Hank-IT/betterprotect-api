<template>
    <b-form>
        <b-form-checkbox v-model="form.postfix_feature_enabled" :value="1" :unchecked-value="0">{{ translate('features.postfix.name') }}</b-form-checkbox>

        <template v-if="form.postfix_feature_enabled">
            <b-form-group :label="translate('misc.database.host') + ' *'">
                <b-form-input :class="{ 'is-invalid': errors.postfix_db_host }" type="text" v-model="form.postfix_db_host" :placeholder="translate('misc.database.host')"></b-form-input>
            ...
            <b-form-group :label="translate('misc.database.name') + ' *'">
                <b-form-input :class="{ 'is-invalid': errors.postfix_db_name }" type="text" v-model="form.postfix_db_name" :placeholder="translate('misc.database.name')"></b-form-input>
            ...
            <b-form-group :label="translate('misc.database.user')">
                <b-form-input :class="{ 'is-invalid': errors.postfix_db_user }" type="text" v-model="form.postfix_db_user" :placeholder="translate('misc.database.user')"></b-form-input>
            ...
            <b-form-group :label="translate('misc.database.password')">
                <b-input-group>
                    <b-form-input :class="{ 'is-invalid': errors.postfix_db_password }" type="password" v-model="form.postfix_db_password" :placeholder="translate('misc.database.password')"></b-form-input>
            ...
            <b-form-group :label="translate('misc.database.port') + ' *'">
                <b-form-input :class="{ 'is-invalid': errors.postfix_db_port }" type="text" v-model="form.postfix_db_port" :placeholder="translate('misc.database.port')"></b-form-input>
